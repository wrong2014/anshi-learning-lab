...
ALLOWED_OPTION_IDS = {
    ...
    # P3 动态学科探针
    "math_calc_carry_borrow", "math_calc_miscopy", "math_calc_decimal_point",
    "math_calc_multistep_break", "math_concept_recite_only", "math_concept_confuse",
    "math_concept_real_meaning", "math_read_miss_condition", "math_read_unsure_keyword",
    "math_read_not_understand_ask", "math_trans_text_to_expr", "math_trans_cant_draw",
    "math_trans_table_relation", "math_method_no_idea", "math_method_unsure",
    "math_method_right_but_why", "math_repeat_same_ok_variant_fail",
    "math_repeat_understand_then_forget", "math_repeat_only_cram",
    "math_attn_multi_condition", "math_attn_composite", "math_attn_midway_forget",
    "math_wrong_causal_direction", "math_wrong_intuitive_rule",
    "math_wrong_previous_misunderstand",
    "phys_calc_unit_direction", "phys_calc_formula_sub", "phys_calc_multistep_lost",
    "phys_concept_formula_no_meaning", "phys_concept_naive_theory", "phys_concept_cant_explain",
    "phys_read_miss_condition", "phys_read_unsure_scene",
    "phys_trans_no_diagram", "phys_trans_scene_to_model",
    "phys_method_no_idea", "phys_method_confuse_law",
    "phys_repeat_template_ok", "phys_repeat_forget_quickly",
    "phys_attn_multi_object", "phys_attn_composite",
    "phys_wrong_force_motion", "phys_wrong_current_consumed",
    "chem_calc_balance", "chem_calc_valence", "chem_calc_mole_mass",
    "chem_concept_particle_confuse", "chem_concept_conservation",
    "chem_read_miss_condition", "chem_read_unsure_symbol",
    "chem_trans_macro_micro", "chem_trans_equation_to_scene",
    "chem_method_no_idea", "chem_method_cant_transfer",
    "chem_repeat_template_ok", "chem_repeat_forget_quickly",
    "chem_attn_multi_step", "chem_attn_mix_calc",
    "chem_wrong_valence_misconception", "chem_wrong_reaction_rule",
}
